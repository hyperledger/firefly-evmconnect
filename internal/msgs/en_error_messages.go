...
var (
	...
	MsgUnknownJSONFormatOption                  = ffe("FF23066", "Unknown JSON formatting option '%s=%s'. Options must be URL query string key=value pairs (e.g. mode=object&number=hex-0x). Supported options and values: %s")

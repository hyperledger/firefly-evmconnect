...
var (
	...
	MsgInvalidListenerOptions    = ffe("FF23033", "Invalid listener options supplied: %s")
	...
	MsgCacheInitFail             = ffe("FF23030", "Failed to initialize cache")
	MsgStreamNotStarted          = ffe("FF23031", "Event stream %s not started")
	MsgStreamAlreadyStarted      = ffe("FF23032", "Event stream %s already started")
)

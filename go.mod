...
require (
	...
	github.com/hyperledger/firefly-common v1.2.18-0.20230630060405-9066e7027d62
	github.com/hyperledger/firefly-signer v1.1.9
	github.com/hyperledger/firefly-transaction-manager v1.2.14-0.20230630060514-4fd28d4e1b8a

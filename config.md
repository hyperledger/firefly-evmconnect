...
|catchupThreshold|How many blocks behind the stable threshold (the chain head minus checkpointBlockGap) an event stream or listener must be to enter catchup mode|`int`|`500`

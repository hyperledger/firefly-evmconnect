...
|catchupThreshold|How many blocks behind the safe point (the chain head minus checkpointBlockGap) an event stream or listener must be to enter catchup mode|`int`|`500`
